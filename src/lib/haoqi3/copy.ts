/**
 * /haoqi3 — content for the third alternate TodayOS landing page ("the console" cut).
 *
 ...
 * only: boot-log labels, prompt strings, key hints — none of which carries a
 * new product claim (figures come from FIXTURES; phrases like "spend-cap gate",
 * "ledger", "a human at the switch" are lifted from the approved set).
 */
...
/** The authorization prompt around the creed (SEC. 02). */
export const PROMPT_TITLE = "AUTHORIZATION REQUIRED — 3 PROPOSALS PENDING"
export const PROMPT_KEYS = "[Y] APPROVE · [N] REFUSE — A HUMAN AT THE SWITCH"
